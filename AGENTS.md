...
| `Tests/` | 645 tests in 48 suites, all offline. Six targets; `swift test` is the only figure worth quoting, because a per-target filter matches suite names across targets and double counts. |
