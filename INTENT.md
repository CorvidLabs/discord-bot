...
- [rain](hi/rain.md): RAIN (31 criteria)
- [repeat](hi/repeat.md): REPEAT (13 criteria)
- [reserve](hi/reserve.md): RESERVE (55 criteria)
- [role](hi/role.md): ROLE (11 criteria)
- [run](hi/run.md): RUN (17 criteria)
- [see](hi/see.md): SEE (19 criteria)
- [show](hi/show.md): SHOW (9 criteria)
- [spend](hi/spend.md): SPEND (23 criteria)
- [trust](hi/trust.md): TRUST (10 criteria)
- [verify](hi/verify.md): VERIFY (16 criteria)
